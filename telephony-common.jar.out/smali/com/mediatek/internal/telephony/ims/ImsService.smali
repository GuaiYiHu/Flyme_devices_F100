...
.method static synthetic access$100(Lcom/mediatek/internal/telephony/ims/ImsService;Landroid/content/Context;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    ...
    .prologue
    .line 93
    invoke-direct {p0, p1, p2}, Lcom/mediatek/internal/telephony/ims/ImsService;->updateImsResrouceCapability(Landroid/content/Context;Landroid/content/Intent;)V

    return-void
.end method

.method static synthetic access$1000(Lcom/mediatek/internal/telephony/ims/ImsService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    .param p1, "x1"    # I
...
.method static synthetic access$1102(Lcom/mediatek/internal/telephony/ims/ImsService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    .param p1, "x1"    # I
...
.method static synthetic access$1200(Lcom/mediatek/internal/telephony/ims/ImsService;Landroid/os/AsyncResult;)V
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
...
.method static synthetic access$1300(Lcom/mediatek/internal/telephony/ims/ImsService;II)I
    .locals 1
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$202(Lcom/mediatek/internal/telephony/ims/ImsService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    .param p1, "x1"    # I
...
.method static synthetic access$500(Lcom/mediatek/internal/telephony/ims/ImsService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
...
.method static synthetic access$600(Lcom/mediatek/internal/telephony/ims/ImsService;)Lcom/mediatek/internal/telephony/ims/ImsRILAdapter;
    .locals 1
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
...
.method static synthetic access$700(Lcom/mediatek/internal/telephony/ims/ImsService;)I
    .locals 1
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
...
.method static synthetic access$702(Lcom/mediatek/internal/telephony/ims/ImsService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    .param p1, "x1"    # I
...
.method static synthetic access$800(Lcom/mediatek/internal/telephony/ims/ImsService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
    .param p1, "x1"    # I
...
.method static synthetic access$900(Lcom/mediatek/internal/telephony/ims/ImsService;)I
    .locals 1
    .param p0, "x0"    # Lcom/mediatek/internal/telephony/ims/ImsService;
...
.method private updateImsResrouceCapability(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 200
    .local v4, "imsConfig":Lcom/android/ims/internal/IImsConfig;
    const-string v17, "ss"
    ...
    const-string v18, "persist.mtk_dynamic_ims_switch"
    ...
    const-string v19, "updateImsResrouceCapability "
    ...
    invoke-static {v0, v10, v1}, Lcom/android/ims/ImsManager;->updateImsServiceConfig(Landroid/content/Context;IZ)V
    ...
    iget-object v0, v0, Lcom/mediatek/internal/telephony/ims/ImsService;->mImsConfigInstanceMap:Ljava/util/Map;
    ...
    const-string v19, "setImsResCapability to volte only w/o SIM on phone "
    ...
    .line 232
    .local v14, "vilteResVal":I
    const/16 v16, 0x0

    .line 234
    .local v16, "wfcResVal":I
    const/16 v17, 0x1
    ...
    .line 286
    .end local v14    # "vilteResVal":I
    .end local v15    # "volteResVal":I
    .end local v16    # "wfcResVal":I
    :catch_0
    move-exception v3
    ...
    const-string v19, "SetImsCapability fail: "
    ...
    invoke-direct {v5, v0}, Lcom/mediatek/ims/ImsConfigStub;-><init>(Landroid/content/Context;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    .line 218
    .end local v4    # "imsConfig":Lcom/android/ims/internal/IImsConfig;
    .local v5, "imsConfig":Lcom/android/ims/internal/IImsConfig;
    :try_start_3
    move-object/from16 v0, p0
    ...
    .end local v5    # "imsConfig":Lcom/android/ims/internal/IImsConfig;
    .restart local v4    # "imsConfig":Lcom/android/ims/internal/IImsConfig;
    goto :goto_1
    ...
    .line 236
    invoke-static {v10}, Lcom/mediatek/internal/telephony/ims/ImsService;->isTestSim(I)Z
    ...
    invoke-virtual {v13, v10}, Landroid/telephony/TelephonyManager;->getSimOperatorNumericForPhone(I)Ljava/lang/String;
    ...
    const-string v18, "Invalid mcc-mnc, reload later."
    ...
    const-string v19, "SIM loaded on phone "
    ...
    .line 254
    .local v8, "newConfiguration":Landroid/content/res/Configuration;
    ...
    iput v0, v8, Landroid/content/res/Configuration;->mnc:I
    ...
    invoke-virtual {v11, v8, v0}, Landroid/content/res/Resources;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;)V
    ...
    invoke-static/range {v17 .. v17}, Lcom/mediatek/internal/telephony/ims/ImsService;->mapFeatureValue(Z)I
    ...
    .line 262
    .restart local v14    # "vilteResVal":I
    const v17, 0x80c0009
    ...
    const-string v19, "Set volte res capability: "
    ...
    const-string v19, "Set vilte res capability: "
    ...
    const-string v19, "Set wfc res capability: "
    ...
    invoke-interface {v4, v0, v15}, Lcom/android/ims/internal/IImsConfig;->setImsResCapability(II)V
    ...
    invoke-interface {v4, v0, v14}, Lcom/android/ims/internal/IImsConfig;->setImsResCapability(II)V
    ...
    invoke-interface {v4, v0, v1}, Lcom/android/ims/internal/IImsConfig;->setImsResCapability(II)V
    ...
    .end local v15    # "volteResVal":I
    .end local v16    # "wfcResVal":I
    .restart local v8    # "newConfiguration":Landroid/content/res/Configuration;
    ...
    const-string v19, "Found test SIM on phone "
    ...
    .end local v15    # "volteResVal":I
    .end local v16    # "wfcResVal":I
    .restart local v5    # "imsConfig":Lcom/android/ims/internal/IImsConfig;
    :catchall_1
    move-exception v17
...
.method public getConfigInterface(I)Lcom/android/ims/internal/IImsConfig;
    ...
    const-string v5, "updateCdmaPhoneId: "
    ...
    invoke-direct {v2, v3}, Lcom/mediatek/ims/ImsConfigStub;-><init>(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
