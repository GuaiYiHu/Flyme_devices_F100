...
.field private static final NITZ_UPDATE_DIFF_DEFAULT:I = 0x2710
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 314
    const-string v7, "ro.nitz_update_diff"
    ...
    iput v7, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mNitzUpdateDiff:I
...
.method private onInvalidSimInfoReceived(Landroid/os/AsyncResult;)V
    ...
    .line 4103
    :cond_4
    iget-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mEverIVSR:Z

    if-nez v6, :cond_0

    iget v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->gprsState:I
    ...
    .line 4105
    const-string v6, "InvalidSimInfo set TRM due to never set IVSR"
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    const-string v33, " exceeds limit, skip NITZ time update"
    ...
    const-string v33, "[NITZ] setTimeFromNITZString,tzname:"
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/telephony/gsm/GSMPhone;->getPhoneId()I

    move-result v33

    invoke-virtual/range {v32 .. v33}, Landroid/telephony/TelephonyManager;->getNetworkCountryIsoForPhone(I)Ljava/lang/String;
    ...
    const-string v33, "[NITZ] setTimeFromNITZString,mGotCountryCode:"
    ...
    .restart local v29    # "updateZone":Z
    :cond_10
    const/16 v29, 0x0
    ...
    iget v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mNitzUpdateDiff:I
    ...
    const-string v33, "NITZ: xush:ignore, difftime ="
...
.method protected updateSpnDisplay(Z)V
    ...
    .line 1486
    :cond_11
    invoke-static {}, Lcom/android/internal/telephony/gsm/GnDecorateOperatorName;->getInstance()Lcom/android/internal/telephony/gsm/GnDecorateOperatorName;

    move-result-object v2

    invoke-virtual {v2, v3}, Lcom/android/internal/telephony/gsm/GnDecorateOperatorName;->Parse(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 1487
    const-string v2, "ro.gn.custom.operators"
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/internal/telephony/gsm/GnDecorateOperatorName;->addRadioTech(Ljava/lang/String;Landroid/telephony/ServiceState;)Ljava/lang/String;
