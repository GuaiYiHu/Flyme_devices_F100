...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService Amigo_SettingsProvider
...
#-----------------------------------------------------------------------------
vendor_modify_jars := amigoframework android.policy framework mediatek-framework mediatek-telephony-common services telephony-common wifi-service
...
override_property += \
    ...
    ro.product.model_romer=F1000_GuaiYiHu
