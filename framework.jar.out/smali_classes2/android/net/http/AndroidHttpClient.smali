...
.field private static mMMSCSet:Ljava/util/HashSet;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/net/http/AndroidHttpClient;->mUserAgent:Ljava/lang/String;
    ...
    sput-object v0, Landroid/net/http/AndroidHttpClient;->mMMSCSet:Ljava/util/HashSet;

    .line 570
    sget-object v0, Landroid/net/http/AndroidHttpClient;->mMMSCSet:Ljava/util/HashSet;

    const-string v1, "mmsc.myuni.com.cn"
    ...
    const-string v1, "mmsc.vnet.mobi"
    ...
    const-string v1, "mmsc.monternet.com"
...
# virtual methods
.method public amigoExecute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .prologue
    .line 576
    sget-object v2, Landroid/net/http/AndroidHttpClient;->mMMSCSet:Ljava/util/HashSet;
    ...
    const-string v2, "Android-Mms/2.0"

    sget-object v3, Landroid/net/http/AndroidHttpClient;->mUserAgent:Ljava/lang/String;
    ...
    const-string v3, "android.permission.SEND_SMS_MMS"
    ...
    const-string v4, "permissionCheck "
    ...
    sput-object v2, Landroid/net/http/AndroidHttpClient;->mUserAgent:Ljava/lang/String;
    ...
    invoke-interface {v2, p1, p2}, Lorg/apache/http/client/HttpClient;->execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;)Lorg/apache/http/HttpResponse;
    ...
    .line 581
    .restart local v1    # "permissionCheck":I
    :catch_0
    move-exception v0
    ...
    const-string v3, "ActivityManagerNative.getDefault().checkPermission RemoteException "
...
.method public execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;)Lorg/apache/http/HttpResponse;
    ...
    .prologue
    .line 305
    invoke-virtual {p0, p1, p2}, Landroid/net/http/AndroidHttpClient;->amigoExecute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;)Lorg/apache/http/HttpResponse;
