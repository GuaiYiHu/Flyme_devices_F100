...
# instance fields
.field public amigoFont:Ljava/lang/String;
...
.method private diffAmigoFont(Landroid/content/res/Configuration;I)I
    .locals 2
    ...
    .prologue
    .line 1118
    iget-object v0, p1, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;

    iget-object v1, p1, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;
...
.method private updateAmigoFont(Landroid/content/res/Configuration;I)I
    .locals 2
    .param p1, "delta"    # Landroid/content/res/Configuration;
    .param p2, "changed"    # I
    ...
    iput-object v0, p0, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;
...
.method public compareTo(Landroid/content/res/Configuration;)I
    ...
    .line 1277
    iget-object v4, p0, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;

    .line 1278
    .local v4, "s1":Ljava/lang/String;
    iget-object v5, p1, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;
    ...
    .line 1287
    :cond_4
    iget v8, p0, Landroid/content/res/Configuration;->mcc:I

    iget v9, p1, Landroid/content/res/Configuration;->mcc:I
    ...
    .line 1289
    iget v8, p0, Landroid/content/res/Configuration;->mnc:I

    iget v9, p1, Landroid/content/res/Configuration;->mnc:I
    ...
    .line 1291
    iget-object v8, p0, Landroid/content/res/Configuration;->locale:Ljava/util/Locale;
    ...
    .line 1296
    :cond_6
    iget-object v6, p0, Landroid/content/res/Configuration;->locale:Ljava/util/Locale;
    ...
    .line 1303
    :cond_7
    iget v6, p0, Landroid/content/res/Configuration;->touchscreen:I

    iget v7, p1, Landroid/content/res/Configuration;->touchscreen:I

    sub-int v2, v6, v7

    if-nez v2, :cond_0

    iget v6, p0, Landroid/content/res/Configuration;->keyboard:I
    ...
    iget v6, p0, Landroid/content/res/Configuration;->keyboardHidden:I

    iget v7, p1, Landroid/content/res/Configuration;->keyboardHidden:I

    sub-int v2, v6, v7

    if-nez v2, :cond_0

    iget v6, p0, Landroid/content/res/Configuration;->hardKeyboardHidden:I
    ...
    iget v6, p0, Landroid/content/res/Configuration;->navigation:I

    iget v7, p1, Landroid/content/res/Configuration;->navigation:I

    sub-int v2, v6, v7

    if-nez v2, :cond_0

    iget v6, p0, Landroid/content/res/Configuration;->navigationHidden:I

    iget v7, p1, Landroid/content/res/Configuration;->navigationHidden:I
    ...
    iget v7, p1, Landroid/content/res/Configuration;->screenLayout:I

    sub-int v2, v6, v7

    if-nez v2, :cond_0

    iget v6, p0, Landroid/content/res/Configuration;->uiMode:I
...
.method public diff(Landroid/content/res/Configuration;)I
    ...
    .line 1037
    .local v0, "changed":I
    invoke-direct {p0, p1, v0}, Landroid/content/res/Configuration;->diffAmigoFont(Landroid/content/res/Configuration;I)I
...
.method public hashCode()I
    ...
    .line 1349
    .local v0, "result":I
    iget-object v1, p0, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    .line 675
    iget-object v2, p0, Landroid/content/res/Configuration;->amigoFont:Ljava/lang/String;
...
.method public updateFrom(Landroid/content/res/Configuration;)I
    ...
    .line 855
    .local v0, "changed":I
    invoke-direct {p0, p1, v0}, Landroid/content/res/Configuration;->updateAmigoFont(Landroid/content/res/Configuration;I)I
