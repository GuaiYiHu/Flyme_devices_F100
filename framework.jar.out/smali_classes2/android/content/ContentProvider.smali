...
.method private amigoGetNewPermission(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    .locals 5
    ...
    .line 1973
    .local v0, "componentPerm":Ljava/lang/String;
    const-string v1, "_CONTACTS"
    ...
    const-string v2, "_CONTACTS_CALLS"
...
.method protected enforceReadPermissionInner(Landroid/net/Uri;Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, v11, v1}, Landroid/content/ContentProvider;->amigoGetNewPermission(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    sget-object v6, Landroid/util/AmigoCheckPermission;->mCheckPermissions:Ljava/util/HashSet;
    ...
    .line 588
    new-instance v6, Landroid/util/AmigoSecurityException;
    ...
    invoke-direct {v6, v7}, Landroid/util/AmigoSecurityException;-><init>(Ljava/lang/String;)V
    ...
    .line 592
    .restart local v12    # "failReason":Ljava/lang/String;
    :cond_a
...
.method protected enforceWritePermissionInner(Landroid/net/Uri;Landroid/os/IBinder;)V
    ...
    invoke-static {v5, v3}, Landroid/os/UserHandle;->isSameApp(II)Z
    ...
    invoke-direct {v0, v10, v1}, Landroid/content/ContentProvider;->amigoGetNewPermission(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v10, v4, v5, v0}, Landroid/content/Context;->checkPermission(Ljava/lang/String;IILandroid/os/IBinder;)I
    ...
    .line 635
    .local v18, "pps":[Landroid/content/pm/PathPermission;
    if-eqz v18, :cond_6
    ...
    .line 638
    .local v17, "pp":Landroid/content/pm/PathPermission;
    invoke-virtual/range {v17 .. v17}, Landroid/content/pm/PathPermission;->getWritePermission()Ljava/lang/String;

    move-result-object v16

    .line 639
    .local v16, "pathPerm":Ljava/lang/String;
    if-eqz v16, :cond_4

    move-object/from16 v0, v17

    invoke-virtual {v0, v15}, Landroid/content/pm/PathPermission;->match(Ljava/lang/String;)Z
    ...
    .end local v16    # "pathPerm":Ljava/lang/String;
    .end local v17    # "pp":Landroid/content/pm/PathPermission;
    .end local v18    # "pps":[Landroid/content/pm/PathPermission;
    :cond_5
    const/4 v8, 0x0
    ...
    .restart local v18    # "pps":[Landroid/content/pm/PathPermission;
    :cond_6
    if-nez v8, :cond_0
    ...
    sget-object v3, Landroid/util/AmigoCheckPermission;->mCheckPermissions:Ljava/util/HashSet;
    ...
    .line 669
    new-instance v3, Landroid/util/AmigoSecurityException;
    ...
    invoke-direct {v3, v6}, Landroid/util/AmigoSecurityException;-><init>(Ljava/lang/String;)V
