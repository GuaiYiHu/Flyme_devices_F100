...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v5, p0, Lcom/android/internal/widget/LockPatternView;->mPaintOutSide:Landroid/graphics/Paint;

    .line 72
    const/high16 v5, 0x3f800000    # 1.0f

    iput v5, p0, Lcom/android/internal/widget/LockPatternView;->mDensity:F
    ...
    .line 295
    invoke-direct {p0, v8}, Lcom/android/internal/widget/LockPatternView;->dipsToPixels(I)I
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/widget/LockPatternView;->dipsToPixels(I)I
    ...
    .line 325
    iget-object v5, p0, Lcom/android/internal/widget/LockPatternView;->mPaintOutSide:Landroid/graphics/Paint;
...
.method private dipsToPixels(I)I
    ...
    iget v1, p0, Lcom/android/internal/widget/LockPatternView;->mDensity:F
...
.method private drawCircleOutSide(Landroid/graphics/Canvas;FFFZF)V
    .locals 3
    .param p1, "canvas"    # Landroid/graphics/Canvas;
    .param p2, "centerX"    # F
    .param p3, "centerY"    # F
    ...
    .prologue
    .line 1072
    iget-object v0, p0, Lcom/android/internal/widget/LockPatternView;->mPaintOutSide:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, Lcom/android/internal/widget/LockPatternView;->mPaintOutSide:Landroid/graphics/Paint;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 912
    .local v36, "pattern":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/widget/LockPatternView$Cell;>;"
    ...
    .line 936
    .local v32, "needToUpdateInProgressPoint":Z
    :goto_1
    if-eqz v32, :cond_1
    ...
    .line 941
    .local v37, "percentageOfNextCircle":F
    ...
    .line 942
    .local v22, "currentCell":Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    check-cast v33, Lcom/android/internal/widget/LockPatternView$Cell;

    .line 946
    .local v33, "nextCell":Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    mul-float v27, v37, v4

    .line 950
    .local v27, "dy":F
    add-float v4, v19, v26
    ...
    .line 954
    .end local v19    # "centerX":F
    .end local v20    # "centerY":F
    .end local v22    # "currentCell":Lcom/android/internal/widget/LockPatternView$Cell;
    .end local v26    # "dx":F
    .end local v27    # "dy":F
    .end local v33    # "nextCell":Lcom/android/internal/widget/LockPatternView$Cell;
    .end local v37    # "percentageOfNextCircle":F
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/widget/LockPatternView;->invalidate()V

    .line 957
    .end local v28    # "i":I
    .end local v32    # "needToUpdateInProgressPoint":Z
    .end local v34    # "numCircles":I
    .end local v35    # "oneCycle":I
    ...
    .line 958
    .local v23, "currentPath":Landroid/graphics/Path;
    ...
    aget-object v18, v4, v29

    .line 965
    .local v18, "cellState":Lcom/android/internal/widget/LockPatternView$CellState;
    move-object/from16 v0, p0
    ...
    .line 966
    .restart local v19    # "centerX":F
    move-object/from16 v0, v18

    iget v4, v0, Lcom/android/internal/widget/LockPatternView$CellState;->size:F

    move-object/from16 v0, v18

    iget v5, v0, Lcom/android/internal/widget/LockPatternView$CellState;->scale:F
    ...
    iget v0, v0, Lcom/android/internal/widget/LockPatternView$CellState;->translateY:F

    move/from16 v40, v0

    .line 968
    .local v40, "translationY":F
    move/from16 v0, v19
    ...
    aget-object v4, v24, v28

    aget-boolean v9, v4, v29

    move-object/from16 v0, v18

    iget v10, v0, Lcom/android/internal/widget/LockPatternView$CellState;->alpha:F
    ...
    add-float v12, v4, v40

    const/16 v4, 0x44

    move-object/from16 v0, p0

    invoke-direct {v0, v4}, Lcom/android/internal/widget/LockPatternView;->dipsToPixels(I)I
    ...
    aget-boolean v14, v4, v29

    move-object/from16 v0, v18

    iget v15, v0, Lcom/android/internal/widget/LockPatternView$CellState;->alpha:F

    move-object/from16 v9, p0

    move-object/from16 v10, p1

    invoke-direct/range {v9 .. v15}, Lcom/android/internal/widget/LockPatternView;->drawCircleOutSide(Landroid/graphics/Canvas;FFFZF)V
    ...
    .line 933
    .end local v8    # "size":F
    .end local v18    # "cellState":Lcom/android/internal/widget/LockPatternView$CellState;
    .end local v19    # "centerX":F
    .end local v20    # "centerY":F
    .end local v23    # "currentPath":Landroid/graphics/Path;
    .end local v29    # "j":I
    .end local v40    # "translationY":F
    .restart local v34    # "numCircles":I
    .restart local v35    # "oneCycle":I
    ...
    .end local v38    # "spotInCycle":I
    .restart local v20    # "centerY":F
    .restart local v23    # "currentPath":Landroid/graphics/Path;
    ...
    .end local v30    # "lastX":F
    .end local v31    # "lastY":F
    :cond_8
    return-void
    ...
    .line 998
    .restart local v16    # "anyCircles":Z
    .restart local v17    # "cell":Lcom/android/internal/widget/LockPatternView$Cell;
    .restart local v25    # "drawPath":Z
    .restart local v30    # "lastX":F
    .restart local v31    # "lastY":F
    :cond_a
    const/16 v16, 0x1
