...
.field static final TAG_DI:Ljava/lang/String; = "Dual_Instance"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/ContextImpl;->DI_ON:Z
...
.method private amigoEnforce(Ljava/lang/String;ZILjava/lang/String;)V
    .locals 5
    ...
    sget-object v1, Landroid/util/AmigoCheckPermission;->mCheckPermissions:Ljava/util/HashSet;
    ...
    .line 2707
    new-instance v2, Landroid/util/AmigoSecurityException;
    ...
    invoke-direct {v2, v1}, Landroid/util/AmigoSecurityException;-><init>(Ljava/lang/String;)V
...
.method private enforce(Ljava/lang/String;IZILjava/lang/String;)V
    ...
    .line 2076
    new-instance v1, Landroid/util/AmigoSecurityException;
    ...
    invoke-direct {v1, v0}, Landroid/util/AmigoSecurityException;-><init>(Ljava/lang/String;)V
...
.method private isCloneOn()Z
    ...
    .line 2757
    :try_start_0
    const-string v6, "amigo.provider.AmigoSettings"
    ...
    const-string v9, "display_wechat_avatar"
...
.method public enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, v1, p2}, Landroid/app/ContextImpl;->amigoEnforce(Ljava/lang/String;ZILjava/lang/String;)V
...
.method getDualInsIntent(Landroid/content/Intent;)Landroid/content/Intent;
    .locals 3
    .param p1, "orgIntent"    # Landroid/content/Intent;

    .prologue
    .line 2748
    new-instance v0, Landroid/content/Intent;

    const-string v1, "android.intent.action.DUAL_INSTANCE_CHOOSER"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2749
    .local v0, "dualChooser":Landroid/content/Intent;
    const-string v1, "CLONE_PKG_NAME"
    ...
    .line 2750
    const-string v1, "EXTRA_ORG_INTENT"
...
.method isCallingWxPay(Landroid/content/Intent;)Z
    .locals 8
    ...
    const-string v4, "com.tencent.mm.plugin.base.stub.WXPayEntryActivity"

    .line 2729
    .local v4, "wxPayCls":Ljava/lang/String;
    ...
    const-string v5, "Dual_Instance"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "cur app="
    ...
    const-string v7, " request wx pay cls="
    ...
    .line 2739
    invoke-direct {p0}, Landroid/app/ContextImpl;->isCloneOn()Z
    ...
    const-string v7, "clone setting on="
...
.method public startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 1379
    sget-boolean v0, Landroid/app/ContextImpl;->DI_ON:Z

    if-eqz v0, :cond_0

    .line 1380
    invoke-virtual {p0, p1}, Landroid/app/ContextImpl;->isCallingWxPay(Landroid/content/Intent;)Z
    ...
    .line 1381
    invoke-virtual {p0, p1}, Landroid/app/ContextImpl;->getDualInsIntent(Landroid/content/Intent;)Landroid/content/Intent;

    move-result-object v5

    .line 1382
    .local v5, "dualInsChoose":Landroid/content/Intent;
    iget-object v0, p0, Landroid/app/ContextImpl;->mMainThread:Landroid/app/ActivityThread;
    ...
    .line 1406
    .end local v5    # "dualInsChoose":Landroid/content/Intent;
    :goto_0
    return-void
    ...
    invoke-virtual/range {v6 .. v13}, Landroid/app/Instrumentation;->execStartActivity(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/Instrumentation$ActivityResult;
