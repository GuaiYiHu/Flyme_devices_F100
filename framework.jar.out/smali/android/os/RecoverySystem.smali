...
.field private static ENCRYPT_FILE:Ljava/io/File; = null
...
.field private static bRebooting:Z
...
.method static constructor <clinit>()V
    ...
    const-string v2, "encrypt_state"

    invoke-direct {v0, v1, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    sput-object v0, Landroid/os/RecoverySystem;->ENCRYPT_FILE:Ljava/io/File;

    .line 94
    const/4 v0, 0x0

    sput-boolean v0, Landroid/os/RecoverySystem;->bRebooting:Z
...
.method public static amigoRebootWipeUserData(Landroid/content/Context;ZLjava/lang/String;ZLjava/lang/String;)V
    .locals 15
    ...
    sput-boolean v1, Landroid/os/RecoverySystem;->bRebooting:Z
    ...
    const-string v4, "AmigoRebootUserdata shutdown = "
    ...
    new-instance v5, Landroid/os/RecoverySystem$2;

    invoke-direct {v5, v10}, Landroid/os/RecoverySystem$2;-><init>(Landroid/os/ConditionVariable;)V
    ...
    const-string v4, "--keep_apk=true"

    aput-object v4, v1, v3

    const/4 v3, 0x5

    const-string v4, "--keep_sd=true"
    ...
    const-string v4, "--keep_apk=false"
...
.method private static varargs bootCommand(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-static {v2, p1}, Landroid/os/RecoverySystem;->WriteByFdSync(Ljava/io/File;[Ljava/lang/String;)V
    ...
    const-string v4, "Current build type is: "
    ...
    invoke-static {v2}, Landroid/os/RecoverySystem;->ReadInAndPrint(Ljava/io/File;)Ljava/lang/String;

    .line 534
    sget-object v2, Landroid/os/RecoverySystem;->ENCRYPT_FILE:Ljava/io/File;
    ...
    invoke-static {v2, v3}, Landroid/os/RecoverySystem;->WriteByFdSync(Ljava/io/File;[Ljava/lang/String;)V
    ...
    .line 541
    invoke-static {}, Landroid/os/RecoverySystem;->recoveryGnProp()V
    ...
    const-string v4, "gnRecoverySystem here, persist.sys.usb.config="
    ...
    const-string v3, "!!! pm.reboot failed !!!\n"
...
.method public static handleAftermath()Ljava/lang/String;
    ...
    .line 644
    :goto_0
    sget-boolean v5, Landroid/os/RecoverySystem;->bRebooting:Z
    ...
    const-string v6, "Doing recovery!!!!"
...
.method private static recoveryGnProp()V
    .locals 5

    .prologue
    .line 559
    const-string/jumbo v0, "persist.sys.ams_first_time_boot"

    .line 560
    .local v0, "AMS_BOOT_SYS_PROPERTY":Ljava/lang/String;
    const-string/jumbo v3, "true"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    .line 564
    const-string/jumbo v3, "persist.sys.amigofont"
    ...
    .line 568
    const-string/jumbo v3, "persist.sys.first_time_boot"
    ...
    .line 569
    const-string/jumbo v3, "persist.sys.boot.count"
    ...
    .line 594
    const-string/jumbo v3, "persist.radio.dispatchAllKey"
    ...
    .line 602
    const-string/jumbo v3, "persist.sys.permission.level"
    ...
    const-string/jumbo v4, "persist.sys.cts.test"
    ...
    .line 607
    .local v1, "hasCtsTest":Z
    if-eqz v1, :cond_1

    .line 608
    const-string/jumbo v3, "persist.sys.cts.test"
    ...
    .line 614
    const-string/jumbo v3, "persist.radio.data.iccid"
    ...
    .line 615
    const-string/jumbo v3, "persist.radio.cfu.iccid.0"
    ...
    .line 618
    const-string/jumbo v3, "persist.sys.senderr.remeber"
    ...
    .line 621
    const-string/jumbo v3, "persist.sys.gamma.index"
