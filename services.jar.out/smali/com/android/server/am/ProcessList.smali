...
# static fields
.field static final BACKUP_APP_ADJ:I
...
# instance fields
.field private final HIGH_RAM_THREHOLD:J
...
.method static constructor <clinit>()V
    ...
    .line 83
    sget-boolean v0, Lcom/android/server/am/ActivityManagerService;->GN_OOM_OPT:Z
    ...
    :goto_1
    sput v2, Lcom/android/server/am/ProcessList;->BACKUP_APP_ADJ:I
...
.method constructor <init>()V
    ...
    iput-wide v6, p0, Lcom/android/server/am/ProcessList;->HIGH_RAM_THREHOLD:J
    ...
    sget v7, Lcom/android/server/am/ProcessList;->HOME_APP_ADJ:I
    ...
    :goto_0
    invoke-direct {p0, v10, v10, v10}, Lcom/android/server/am/ProcessList;->updateOomLevels(IIZ)V
    ...
    sget v7, Lcom/android/server/am/ProcessList;->BACKUP_APP_ADJ:I
    ...
    sget v6, Lcom/android/server/am/ProcessList;->HOME_APP_ADJ:I
...
.method private isHighRamDevice(J)Z
    .locals 3
    .param p1, "totalRam"    # J
...
.method public static makeOomAdjString(I)Ljava/lang/String;
    ...
    .line 517
    :cond_2
    sget v0, Lcom/android/server/am/ProcessList;->BACKUP_APP_ADJ:I
    ...
    sget v1, Lcom/android/server/am/ProcessList;->BACKUP_APP_ADJ:I
...
.method private updateOomLevels(IIZ)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ProcessList;->isHighRamDevice(J)Z
    ...
    .line 460
    .end local v4    # "buf":Ljava/nio/ByteBuffer;
    .end local v13    # "reserve":I
    .end local v14    # "reserve_abs":I
    .end local v15    # "reserve_adj":I
    :cond_11
    const/16 v19, 0xf
    ...
    .line 490
    .restart local v4    # "buf":Ljava/nio/ByteBuffer;
    .restart local v13    # "reserve":I
    .restart local v14    # "reserve_abs":I
    .restart local v15    # "reserve_adj":I
    :cond_12
    invoke-static {v4}, Lcom/android/server/am/ProcessList;->writeLmkd(Ljava/nio/ByteBuffer;)V
