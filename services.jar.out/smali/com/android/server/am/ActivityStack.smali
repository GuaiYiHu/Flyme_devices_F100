...
.method private setThumbnailBlur(Landroid/graphics/Bitmap;ILcom/android/server/am/ActivityRecord;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lcom/android/server/am/ActivityStack$1;-><init>(Lcom/android/server/am/ActivityStack;Landroid/graphics/Bitmap;ILcom/android/server/am/ActivityRecord;)V
...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;I)V
    ...
    const-string v10, "Exception thrown going ensureActivitiesVisibleLocked: "
    ...
    .line 1621
    sget-object v9, Lcom/android/server/am/ActivityStack$2;->$SwitchMap$com$android$server$am$ActivityStack$ActivityState:[I
...
.method findActivityLocked(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 703
    invoke-static {v3, p2}, Lcom/android/server/am/DualInsUtil;->sameRace(Lcom/android/server/am/ActivityRecord;Landroid/content/pm/ActivityInfo;)Z
    ...
    .line 704
    const-string v8, "DualInstance"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Skipping ar="
    ...
    const-string v10, " mismatch race with aInfo="
...
.method findTaskLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-static {v8, v0}, Lcom/android/server/am/DualInsUtil;->sameRace(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 607
    const-string v14, "DualInstance"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "Skipping task="
    ...
    const-string v16, " mismatch race with "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    const-string v16, " target ar ="
    ...
    invoke-static {v7, v0}, Lcom/android/server/am/DualInsUtil;->sameRace(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Z
...
.method final finishTopRunningActivityLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v3, "Exception thrown going finishTopRunningActivityLocked: "
...
.method handleAppCrashLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v6, "Exception thrown going ensureActivitiesVisibleLocked: "
...
.method final moveTaskToBackLocked(I)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/am/AmigoActivityController;->callControllerActivityResuming(Lcom/android/server/am/ActivityStack;Landroid/os/IBinder;)Z
    ...
    .line 4314
    .local v12, "numValidTasks":I
    const/16 v18, 0x0

    .line 4318
    .local v18, "validTask":Lcom/android/server/am/TaskRecord;
    sget-boolean v19, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z
    ...
    .line 4321
    .local v14, "taskDebug":Lcom/android/server/am/TaskRecord;
    const-string v19, "ActivityManager"
    ...
    const-string v21, "mtk debug taskDebug = "
    ...
    const-string v21, "mtk debug taskDebug.mActivities = "
    ...
    .line 4333
    .end local v7    # "iNdx":I
    .end local v14    # "taskDebug":Lcom/android/server/am/TaskRecord;
    :cond_7
    ...
    const-string v21, "Single valid task "
    ...
    const-string v21, ", set over home."
    ...
    const-string v21, "mtk debug moveTaskToBack mResumedActivity = "
    ...
    const-string v21, "Ignore empty task "
    ...
    const-string v21, " when finding home"
    ...
    .line 4416
    .end local v16    # "taskToReturnTo":I
    :cond_1a
    move-object/from16 v0, p0
...
.method final navigateUpToLocked(Landroid/os/IBinder;Landroid/content/Intent;ILandroid/content/Intent;)Z
    ...
    invoke-static {v0, v2}, Lcom/android/server/am/AmigoActivityController;->callControllerActivityResuming(Lcom/android/server/am/ActivityStack;Landroid/os/IBinder;)Z
...
.method final resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-static {v3}, Lcom/android/server/am/AmigoActivityController;->callControllerActivityResuming(Ljava/lang/String;)Z
...
.method final startPausingLocked(ZZZZ)Z
    ...
    .line 957
    .local v9, "mThumbnail":Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v9, v0, v1}, Lcom/android/server/am/ActivityStack;->setThumbnailBlur(Landroid/graphics/Bitmap;ILcom/android/server/am/ActivityRecord;)V

    .line 964
    .end local v9    # "mThumbnail":Landroid/graphics/Bitmap;
    :cond_7
    :goto_3
    const-wide/16 v2, 0x1040
    ...
    .line 960
    .restart local v9    # "mThumbnail":Landroid/graphics/Bitmap;
    .restart local v11    # "next":Lcom/android/server/am/ActivityRecord;
    :cond_f
    const/4 v0, 0x0

    invoke-virtual {v1, v9, v0}, Lcom/android/server/am/ActivityRecord;->updateThumbnailLocked(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
