...
.method private final deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;Z)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/BroadcastQueue;->amiSkipBroadcast(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)Z
    ...
    .line 636
    const-string v2, "DualInstance"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "skip clone br="
...
.method private overloadBroadcast(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;)Z
    .locals 11
    ...
    .prologue
    .local p1, "broadcasts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/BroadcastRecord;>;"
    const/4 v9, 0x1
    ...
    .line 260
    :cond_3
    iget-object v7, p2, Lcom/android/server/am/BroadcastRecord;->resultTo:Landroid/content/IIntentReceiver;
    ...
    invoke-virtual {v7, v5}, Landroid/content/Intent;->filterEquals(Landroid/content/Intent;)Z
    ...
    const-string v10, "too many broadcast, drop duplicate intent:"
    ...
    const-string v8, "too many broadcast, drop duplicate intent!"
...
# virtual methods
.method amiGetProcForBroadcast(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Lcom/android/server/am/ProcessRecord;
    .locals 6
    ...
    invoke-static {v3}, Lcom/android/server/am/DualInsUtil;->getProcAppInfo(Lcom/android/server/am/ProcessRecord;)Landroid/content/pm/ApplicationInfo;

    move-result-object v1

    .line 1494
    .local v1, "callerAppInfo":Landroid/content/pm/ApplicationInfo;
    iget-object v3, p1, Lcom/android/server/am/BroadcastRecord;->curComponent:Landroid/content/ComponentName;

    iget-boolean v4, p1, Lcom/android/server/am/BroadcastRecord;->isClone:Z

    invoke-static {v3, v1, p2, v4}, Lcom/gionee/di/DualInsManager;->getTargetEuid(Landroid/content/ComponentName;Landroid/content/pm/ApplicationInfo;Landroid/content/pm/ResolveInfo;Z)I
    ...
    invoke-virtual {v3, v4, v2, v5}, Lcom/android/server/am/ActivityManagerService;->getProcessRecordLocked(Ljava/lang/String;IZ)Lcom/android/server/am/ProcessRecord;
...
.method amiSkipBroadcast(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)Z
    .locals 3
    .param p1, "br"    # Lcom/android/server/am/BroadcastRecord;
    .param p2, "targetApp"    # Lcom/android/server/am/ProcessRecord;
    ...
    .line 1501
    .local v1, "targetAppInfo":Landroid/content/pm/ApplicationInfo;
    iget-object v2, p1, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;

    invoke-static {v2}, Lcom/android/server/am/DualInsUtil;->getProcAppInfo(Lcom/android/server/am/ProcessRecord;)Landroid/content/pm/ApplicationInfo;

    move-result-object v0

    .line 1503
    .local v0, "callerAppInfo":Landroid/content/pm/ApplicationInfo;
    iget-boolean v2, p1, Lcom/android/server/am/BroadcastRecord;->isClone:Z

    invoke-static {v0, v1, v2}, Lcom/gionee/di/DualInsManager;->skipBroadcast(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/ApplicationInfo;Z)Z
...
.method public enqueueOrderedBroadcastLocked(Lcom/android/server/am/BroadcastRecord;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/am/BroadcastQueue;->overloadBroadcast(Ljava/util/ArrayList;Lcom/android/server/am/BroadcastRecord;)Z
...
.method final processNextBroadcast(Z)V
    ...
    :try_start_f
    sget-boolean v4, Lcom/android/server/am/ActivityManagerService;->DI_ON:Z
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/BroadcastQueue;->amiGetProcForBroadcast(Lcom/android/server/am/BroadcastRecord;Landroid/content/pm/ResolveInfo;)Lcom/android/server/am/ProcessRecord;
