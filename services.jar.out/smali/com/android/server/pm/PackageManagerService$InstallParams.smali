...
.method private installLocationPolicy(Landroid/content/pm/PackageInfoLite;)I
    ...
    .line 9900
    invoke-static {v4}, Lcom/android/server/pm/PackageManagerService;->isVendorApp(Landroid/content/pm/PackageParser$Package;)Z
    ...
    invoke-virtual {v5, v10}, Lcom/android/server/pm/PackageSetting;->readUserState(I)Landroid/content/pm/PackageUserState;
    ...
    iget-boolean v10, v6, Landroid/content/pm/PackageUserState;->installed:Z
    ...
    const-string v11, "set allow_install because isVendorApp == true and state.installed == false "
    ...
    iput v10, p0, Lcom/android/server/pm/PackageManagerService$InstallParams;->installFlags:I
    ...
    invoke-static {v4, p1}, Lcom/android/server/pm/PackageManagerService;->access$3200(Landroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageInfoLite;)V
    :try_end_1
    ...
    const-string v8, "Cannot install update to system app on sdcard"
    ...
    const-string v10, "Downgrade detected: "
    ...
    .line 9959
    :cond_b
    iget v7, p1, Landroid/content/pm/PackageInfoLite;->recommendedInstallLocation:I
...
.method public handleStartCopy()V
    ...
    invoke-static {v4, v0, v6}, Lcom/android/server/pm/PackageManagerService;->access$3500(Lcom/android/server/pm/PackageManagerService;II)Z
    ...
    # getter for: Lcom/android/server/pm/PackageManagerService;->mRequiredVerifierPackage:Ljava/lang/String;
    invoke-static {v6}, Lcom/android/server/pm/PackageManagerService;->access$3400(Lcom/android/server/pm/PackageManagerService;)Ljava/lang/String;
    ...
    invoke-static {v4, v6, v0}, Lcom/android/server/pm/PackageManagerService;->access$3900(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/util/List;)Landroid/content/ComponentName;
