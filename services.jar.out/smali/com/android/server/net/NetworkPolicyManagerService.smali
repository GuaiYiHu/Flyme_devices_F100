...
.field private static DEFAULT_NETWORK_DISABLED:I = 0x0

.field private static final INVALID_SUBSCRIBER_ID:Ljava/lang/String; = "FFFFFFFFFFFFFFF"

.field private static LIST_TAG:Ljava/lang/String; = null
...
.field private static NETWORK_DISABLED:I = 0x0
...
.field private static UID_TAG:Ljava/lang/String; = null
...
.field private final mDisableNetworkFile:Landroid/util/AtomicFile;
...
.field private mUidDisableNetwork:Landroid/util/SparseIntArray;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/net/NetworkPolicyManagerService;->LIST_TAG:Ljava/lang/String;

    .line 2530
    const-string v0, "uid"

    sput-object v0, Lcom/android/server/net/NetworkPolicyManagerService;->UID_TAG:Ljava/lang/String;

    .line 2531
    const/4 v0, 0x1

    sput v0, Lcom/android/server/net/NetworkPolicyManagerService;->NETWORK_DISABLED:I

    .line 2532
    const/4 v0, -0x1

    sput v0, Lcom/android/server/net/NetworkPolicyManagerService;->DEFAULT_NETWORK_DISABLED:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/os/IPowerManager;Landroid/net/INetworkStatsService;Landroid/os/INetworkManagementService;Landroid/util/TrustedTime;Ljava/io/File;Z)V
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidDisableNetwork:Landroid/util/SparseIntArray;
    ...
    const-string v3, "disablenetwork.xml"

    invoke-direct {v2, p7, v3}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {v1, v2}, Landroid/util/AtomicFile;-><init>(Ljava/io/File;)V

    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mDisableNetworkFile:Landroid/util/AtomicFile;

    .line 356
    return-void
.end method

.method private Amigo_isUidForeground(I)Z
    .locals 3
    .param p1, "uid"    # I
    ...
    iget-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidDisableNetwork:Landroid/util/SparseIntArray;

    sget v2, Lcom/android/server/net/NetworkPolicyManagerService;->DEFAULT_NETWORK_DISABLED:I

    invoke-virtual {v1, p1, v2}, Landroid/util/SparseIntArray;->get(II)I

    move-result v1

    sget v2, Lcom/android/server/net/NetworkPolicyManagerService;->NETWORK_DISABLED:I
...
.method private Amigo_procRemovedPackage(Ljava/lang/String;I)V
    .locals 3
    ...
    .line 2580
    iget-object v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidDisableNetwork:Landroid/util/SparseIntArray;

    invoke-virtual {v0, p2}, Landroid/util/SparseIntArray;->delete(I)V

    .line 2581
    invoke-direct {p0}, Lcom/android/server/net/NetworkPolicyManagerService;->Amigo_writeDisableNetworkRules()V
...
.method private Amigo_readDisableNetworkRules()V
    .locals 9

    .prologue
    .line 2586
    iget-object v6, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidDisableNetwork:Landroid/util/SparseIntArray;
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mDisableNetworkFile:Landroid/util/AtomicFile;
    ...
    .line 2596
    sget-object v6, Lcom/android/server/net/NetworkPolicyManagerService;->UID_TAG:Ljava/lang/String;
    ...
    sget v8, Lcom/android/server/net/NetworkPolicyManagerService;->NETWORK_DISABLED:I
    ...
    const-string v7, "Amigo_readDisableNetworkRules"
...
.method private Amigo_writeDisableNetworkRules()V
    .locals 7
    ...
    const-string v6, "Amigo_writeDisableNetworkRules()"
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mDisableNetworkFile:Landroid/util/AtomicFile;
    ...
    sget-object v6, Lcom/android/server/net/NetworkPolicyManagerService;->LIST_TAG:Ljava/lang/String;
    ...
    .local v2, "i":I
    :goto_0
    iget-object v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidDisableNetwork:Landroid/util/SparseIntArray;
...
.method static synthetic access$000(Lcom/android/server/net/NetworkPolicyManagerService;Ljava/lang/String;I)V
    .locals 0
    ...
    .prologue
    .line 191
    invoke-direct {p0, p1, p2}, Lcom/android/server/net/NetworkPolicyManagerService;->Amigo_procRemovedPackage(Ljava/lang/String;I)V
...
.method public Amigo_getMobileNetworkDisabledUids()[I
    ...
    .prologue
    .line 2644
    iget-object v2, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mUidDisableNetwork:Landroid/util/SparseIntArray;
...
.method public Amigo_setMobileNetworkStatusBatch([IZ)V
    ...
    sget v4, Lcom/android/server/net/NetworkPolicyManagerService;->NETWORK_DISABLED:I
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidPolicy(II)V
...
.method public systemReady()V
    ...
    .line 412
    :cond_4
    invoke-direct/range {p0 .. p0}, Lcom/android/server/net/NetworkPolicyManagerService;->Amigo_readDisableNetworkRules()V
...
.method updateNotificationsLocked()V
    ...
    invoke-direct {v0, v4}, Lcom/android/server/net/NetworkPolicyManagerService;->flymeNotifyOverLimitLocked(Landroid/net/NetworkTemplate;)V
    ...
    invoke-direct {v0, v15, v4, v1, v2}, Lcom/android/server/net/NetworkPolicyManagerService;->flymeEnqueueNotification(Landroid/net/NetworkPolicy;IJ)V
    invoke-direct {p0, v15, v1, v1}, Lcom/android/server/net/NetworkPolicyManagerService;->flymeNotifyOverLimitLocked(Landroid/net/NetworkPolicy;J)V
