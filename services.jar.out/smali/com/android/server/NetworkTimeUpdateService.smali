...
.method private onPollNetworkTime(I)V
    ...
    const-string v8, "isAutomaticTimeRequested() = false"
    ...
    :cond_6
    :goto_2
    invoke-virtual {p0, v4, v5, v0, v1}, Lcom/android/server/NetworkTimeUpdateService;->Amigo_notifyStatus(JJ)V
    ...
    const-string v9, "fail : mTryAgainCounter  "
    ...
    .line 332
    invoke-direct {p0}, Lcom/android/server/NetworkTimeUpdateService;->isNetworkConnected()Z
    ...
    const-string v8, "isNetworkConnected() = true"
    ...
    .line 344
    :cond_d
    invoke-virtual {p0}, Lcom/android/server/NetworkTimeUpdateService;->Amigo_notifyStatusFalil()V
    ...
    const-string v8, "isNetworkConnected() = false"
...
# virtual methods
.method public Amigo_networkConnected(Landroid/net/NetworkInfo;)V
    .locals 2
    ...
    invoke-static {p1, v0, v1}, Lcom/android/server/AmigoAutoTime;->onNetworkConnected(Landroid/net/NetworkInfo;ILandroid/os/Handler;)V

    .line 574
    return-void
.end method

.method Amigo_notifyStatus(JJ)V
    .locals 5
    .param p1, "ntp"    # J
    ...
    invoke-static {v0, v1}, Lcom/android/server/AmigoAutoTime;->notifyStatus(Landroid/content/Context;I)V
...
.method Amigo_notifyStatusFalil()V
    .locals 2
...
.method public systemRunning()V
    ...
    const-string v2, "add GPS time sync handler and looper"
    ...
    const-string v2, "Set the year to 2016"
