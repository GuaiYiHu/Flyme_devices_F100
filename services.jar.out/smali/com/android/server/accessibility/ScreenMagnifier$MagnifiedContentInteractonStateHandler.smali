...
# static fields
.field private static final MAX_SCALE_MAGNIFIED_MODE:F = 5.0f

.field private static final MAX_SCALE_SCREEN_MODE:F = 1.0f

.field private static final MIN_SCALE_MAGNIFIED_MODE:F = 1.3f

.field private static final MIN_SCALE_SCREEN_MODE:F = 0.5f

.field private static final SCALING_THRESHOLD:F = 0.1f


# instance fields
.field private MAX_SCALE:F

.field private MIN_SCALE:F
...
.method public constructor <init>(Lcom/android/server/accessibility/ScreenMagnifier;Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;->MIN_SCALE:F

    .line 685
    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;->MAX_SCALE:F
...
.method static synthetic access$1000(Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;)V
    .locals 0
...
.method public onMotionEvent(Landroid/view/MotionEvent;)V
    ...
    iget v2, p0, Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;->MIN_SCALE:F

    invoke-static {v1, v2}, Ljava/lang/Math;->max(FF)F

    move-result v1

    iget v2, p0, Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;->MAX_SCALE:F
    ...
    invoke-static {v1, v0}, Lcom/android/server/accessibility/ScreenMagnifier;->access$1600(Lcom/android/server/accessibility/ScreenMagnifier;F)V
    ...
    invoke-static {v1}, Lcom/android/server/accessibility/ScreenMagnifier;->access$1700(Lcom/android/server/accessibility/ScreenMagnifier;)I
    ...
    invoke-static {v1, v3}, Lcom/android/server/accessibility/ScreenMagnifier;->access$1800(Lcom/android/server/accessibility/ScreenMagnifier;I)V
    ...
    # invokes: Lcom/android/server/accessibility/ScreenMagnifier;->transitionToState(I)V
    invoke-static {v1, v2}, Lcom/android/server/accessibility/ScreenMagnifier;->access$1800(Lcom/android/server/accessibility/ScreenMagnifier;I)V
...
.method public onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    # getter for: Lcom/android/server/accessibility/ScreenMagnifier;->mMagnificationController:Lcom/android/server/accessibility/ScreenMagnifier$MagnificationController;
    invoke-static {v5}, Lcom/android/server/accessibility/ScreenMagnifier;->access$1400(Lcom/android/server/accessibility/ScreenMagnifier;)Lcom/android/server/accessibility/ScreenMagnifier$MagnificationController;
    ...
    .line 744
    .local v1, "newScale":F
    iget v5, p0, Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;->MIN_SCALE:F

    invoke-static {v1, v5}, Ljava/lang/Math;->max(FF)F

    move-result v5

    iget v6, p0, Lcom/android/server/accessibility/ScreenMagnifier$MagnifiedContentInteractonStateHandler;->MAX_SCALE:F
...
.method public onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    # getter for: Lcom/android/server/accessibility/ScreenMagnifier;->mCurrentState:I
    invoke-static {v0}, Lcom/android/server/accessibility/ScreenMagnifier;->access$1300(Lcom/android/server/accessibility/ScreenMagnifier;)I
